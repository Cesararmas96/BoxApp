...
export const BoxDisplay: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 bg-black text-white z-[100] overflow-hidden flex flex-col p-6 animate-in fade-in duration-500">
            {/* Header / Logo */}
            <header className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    <div className="h-12 w-12 bg-primary rounded-lg flex items-center justify-center">
                        <Monitor className="text-black h-8 w-8" />
                    </div>
                    <div>
                        <h1 className="text-2xl font-black italic tracking-tighter uppercase leading-none">BoxApp <span className="text-primary italic">Live</span></h1>
                        <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-muted-foreground">Internal Community Board</p>
                    </div>
                </div>
                <div className="flex items-center gap-6">
                    <div className="text-right">
                        <p className="text-4xl font-black font-mono tracking-tight">{new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
                        <p className="text-xs text-muted-foreground uppercase font-bold tracking-widest">{new Date().toLocaleDateString(undefined, { weekday: 'long', month: 'short', day: 'numeric' })}</p>
                    </div>
                    <Button variant="outline" size="icon" onClick={() => window.location.reload()} className="bg-zinc-900 border-zinc-800">
            ...
            <div className="grid grid-cols-12 gap-8 flex-1">
                ...
                <div className="col-span-8 flex flex-col gap-8">
                    ...
                    <Card className="bg-zinc-900 border-zinc-800 shadow-2xl flex-1 flex flex-col overflow-hidden">
                        ...
                        <CardContent className="flex-1 flex flex-col items-center justify-center p-0">
                            <div className="text-[20rem] font-black font-mono tracking-tighter tabular-nums leading-none select-none text-primary drop-shadow-[0_0_50px_rgba(var(--primary),0.3)]">
                                {formatTime(time)}
                            </div>
                            <div className="flex gap-8 mb-8 scale-150">
                    ...
                    {/* WOD Section */}
                    <Card className="bg-zinc-900 border-zinc-800 shadow-2xl h-[35%] overflow-hidden relative">
                        ...
                        <CardHeader className="pb-2">
                            ...
                            <CardTitle className="text-5xl font-black italic uppercase tracking-tighter text-zinc-100">{currentWod?.title || 'No WOD Scheduled'}</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="grid grid-cols-2 gap-8 h-full">
                                <div className="bg-black/40 rounded-xl p-6 border border-zinc-800 h-full overflow-auto">
                                    <pre className="font-mono text-2xl text-zinc-300 whitespace-pre-wrap leading-tight">
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-zinc-400 text-lg italic leading-snug">
                ...
                <div className="col-span-4 h-full flex flex-col gap-6 overflow-hidden">
                    <Card className="bg-zinc-900 border-zinc-800 shadow-2xl flex-1 flex flex-col overflow-hidden">
                        ...
                        <CardContent className="p-0 overflow-auto scrollbar-hide">
                            <div className="divide-y divide-zinc-800">
                                {results.length === 0 ? (
                                    ...
                                    results.map((res, i) => (
                                        <div key={res.id} className="flex items-center justify-between p-6 hover:bg-white/5 transition-colors animate-in slide-in-from-right duration-500" style={{ animationDelay: `${i * 100}ms` }}>
                                            <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-4xl font-black font-mono tracking-tighter text-primary italic">
                                                {res.result}
                                            </div>
                                        </div>
                                    ))
                    ...
                    <div className="grid grid-cols-2 gap-4 h-[120px]">
                        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex flex-col justify-between">
                            ...
                            <span className="text-5xl font-black italic text-zinc-100">{results.length}</span>
                        </div>
                        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex flex-col justify-between">
                            ...
                            <span className="text-5xl font-black italic text-zinc-100">
            ...
            <footer className="mt-8 flex items-center justify-between text-zinc-600 text-[10px] font-bold uppercase tracking-widest border-t border-zinc-900 pt-6">
                <div className="flex items-center gap-6">
